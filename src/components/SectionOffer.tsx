        ...
        <div className="max-w-5xl mx-auto mt-20">
            <div className="mx-5">
                <div className="flex flex-col  items-center">
                    <h1  className="text-center text-white text-5xl lg:text-6xl    mb-2 font-cactus-classical">МЕРОПРИЯТИЯ</h1>
                    <p className="text-white text-center mb-4">Наше кабаре — идеальное место для банкетов, корпоративов и праздников с шоу.
